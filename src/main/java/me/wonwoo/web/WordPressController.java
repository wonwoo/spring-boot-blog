...
public class WordPressController {
    ...
    @GetMapping
    public String findAll(Model model, @PageableDefault(size = 3, sort = "postDate", direction = Sort.Direction.DESC) Pageable pageable, @RequestParam(required = false) String q) {
