...
public class AsciidoctorUtils {
  ...
  public String generateDynamicSidebar(AsciidocGuide asciidocGuide) {
    ...
    sidebar.append("<h3>" + "<a name='table-of-sidebar' class='anchor' href='#table-of-sidebar'></a>"
        + "Table of sidebar</h3>\n");
    sidebar.append(asciidocGuide.getTableOfContents());
    sidebar.append("</div>\n</div>\n" + "<div class='right-pane-widget--container'>\n"
        + "<div class='related_resources'>\n");
    if (asciidocGuide.getTags().size() > 0) {
      sidebar.append("<h3>" + "<a name='tags' class='anchor' href='#tags'></a>"
          + "Tags</h3><ul class='inline'>\n");
      for (String tag : asciidocGuide.getTags()) {
        sidebar.append("<li><a href='/guides?filter=")
            .append(tag)
            .append("'>")
            .append(tag)
            .append("</a></li>\n");
    ...
    if (asciidocGuide.getProjects().size() > 0) {
      sidebar.append("</ul><h3>" + "<a name='projects' class='anchor' href='#projects'></a>"
          + "Projects</h3>\n" + "<ul class='sectlevel1'>\n");
...
//                sidebar += "<li><a href='" + springIoProject.getSiteUrl() + "'>" + springIoProject.getName()
    ...
    if (asciidocGuide.getUnderstandingDocs().size() > 0) {
      sidebar.append("<h3>" + "<a name='concepts-and-technologies' class='anchor' " +
          "href='#concepts-and-technologies'></a>" + "Concepts and technologies</h3>\n"
          + "<ul class='sectlevel1'>\n");
      for (String key : asciidocGuide.getUnderstandingDocs().keySet()) {
        sidebar.append("<li><a href='")
            .append(key)
            .append("'>")
            .append(asciidocGuide.getUnderstandingDocs().get(key))
            .append("</a></li>\n");
      }
      sidebar.append("</ul>\n");
    }
